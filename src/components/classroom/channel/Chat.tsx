...
const Chat = () => {
    ...
    useEffect(() => {
        ...
        api.get('classroom/messages', {
            params: {channel_name: classroom?.activeChannel?.name},
                    ...
                    <ul className='bottom-0 justify-end'>
                        ...
                        {messages.map((message, index, msgs) => {
                            if (msgs[index - 1] !== undefined && msgs[index - 1].user === message.user) {
                                return (
                                    <li key={index} onContextMenu={(event) => handleMessageContextMenu(event, message)}
                                        className='flex gap-4'>
                                        <div className='w-10'></div>
                                        <div className='flex w-11/12 items-center gap-2'>
                                            <div message-id={message.id} ref={(el) => (messagesRef.current[index] = el)}
                                                 className='my-[2px] whitespace-pre-line'>
                                                {message.text}
                                            </div>
                                            {message.edited &&
                                                <span className='text-[12px] text-gray-500'>edited</span>}
                                        </div>
                                    </li>
                                );
                            } else {
                                    ...
                                    <li key={index} onContextMenu={(event) => handleMessageContextMenu(event, message)}
                                        ...
                                        <div className='w-11/12'>
                                            <div className='flex items-center gap-2'>
                                                ...
                                                <span
                                                    className='text-xs text-gray-400'>{`${formatDate(message.date as Date)}`}</span>
                                            </div>
                                            <div className='flex items-center gap-2'>
                ...
                <ul>
                    ...
                    <li className='mt-4 flex'>
                        ...
                        <div className='w-full'>
                            <div className='mb-2'>
                                <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'90px'}
                                               highlightColor='#1a2329' count={1}/>
                            </div>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'40%'} highlightColor='#1a2329'
                                           count={1}/>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'35%'} highlightColor='#1a2329'
                                           count={1}/>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'19%'} highlightColor='#1a2329'
                                           count={1}/>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'22%'} highlightColor='#1a2329'
                                           count={1}/>
                        </div>
                    </li>
                    <li className='mt-4 flex'>
                        ...
                        <div className='w-full'>
                            <div className='mb-2'>
                                <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'80px'}
                                               highlightColor='#1a2329' count={1}/>
                            </div>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'12%'} highlightColor='#1a2329'
                                           count={1}/>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'37%'} highlightColor='#1a2329'
                                           count={1}/>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'5%'} highlightColor='#1a2329'
                                           count={1}/>
                        </div>
                    </li>
                    <li className='mt-4 flex'>
                        ...
                        <div className='w-full'>
                            <div className='mb-2'>
                                <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'140px'}
                                               highlightColor='#1a2329' count={1}/>
                            </div>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'35%'} highlightColor='#1a2329'
                                           count={1}/>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'40%'} highlightColor='#1a2329'
                                           count={1}/>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'61%'} highlightColor='#1a2329'
                                           count={1}/>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'24%'} highlightColor='#1a2329'
                                           count={1}/>
                            <SkeletonTheme baseColor='#2f363b' height={'20px'} width={'22%'} highlightColor='#1a2329'
                                           count={1}/>
                        </div>
