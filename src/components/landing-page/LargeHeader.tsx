		...
		<nav className='border-b border-b-gray-700'>
			<div className='text-gray flex items-center justify-between p-4 px-12'>
				<div className='flex items-center space-x-12'>
					<img src='/m_manthano.png' alt={'manthano_logo'} onClick={() => redirect()} className='w-8 cursor-pointer' />
					<nav className='flex space-x-4 text-gray-200'>
						...
						<Link className='px-3 py-2 hover:rounded-md hover:bg-gray-700 hover:text-white' to='/join'>
							Classroom
						</Link>
