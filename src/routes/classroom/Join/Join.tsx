...
const Join = () => {
    ...
    return (
        <>
            <div
                className='absolute bottom-1/2 right-1/2 mt-0 w-[400px] translate-x-1/2 translate-y-1/2 rounded-lg border border-gray-700 bg-gray-800 p-0 shadow md:w-[500px]'>
                <div className='space-y-4 p-6'>
                    <div>
                        <h1 className='mb-3 text-2xl font-bold'>Let's get you socializing.</h1>
                        <h2 className='text-gray-300'>Using Manthano gives you the ability to be more productive with
                            Classrooms.</h2>
                        ...
                        <form method='POST' onSubmit={handleJoinClassroomSubmit}>
                            <div className='flex flex-col'>
                                ...
                                <h2 className='mb-2 text-gray-300'>Insert the code below and let's get you to
                                    socialize.</h2>
                                <div className='flex gap-2'>
                                    <TextInputWithButton className='w-full' type='text' name='classroom_code'
                                                         placeholder='Classroom code' buttonLabel='Join'
                                                         buttonType='submit' value={classroomCode}
                                                         onChange={(event: React.ChangeEvent<HTMLInputElement>) => setClassroomCode(event.target.value)}/>
                                </div>
                            </div>
                        </form>
                    </div>
